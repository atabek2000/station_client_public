    ...
    <a-row type="flex" justify="space-between">
      <a-col :xs="{ order: 1, flex: 12 }" :md="{ order: 1, flex: 'auto' }">
        <div class="logo-block">
          <NuxtLink to="/">
            <img src="/img/main/mobile-logo-white.png" alt="" height="40" />
          </NuxtLink>
        </div>
      </a-col>
      ...
      <a-col :xs="{ order: 2, flex: 12 }" :md="{ order: 3, flex: 'auto' }">
        <div class="logo-right-block">
          ...
          <a-badge :count="basketCount().value">
            <ShopBasket page="main" class="text-button ml-16" />
          </a-badge>
          <a-badge>
            <ShopStarred page="main" class="text-button ml-8" />
          </a-badge>
          <div class="lang">
            <span>KZ</span>
            <img src="/img/main/lang-arrow.png" alt="lang-arrow" />
          </div>
        </div>
      </a-col>
    </a-row>
