  ...
  <div>
    <a-row class="catalog-wrapper">
      <a-col :xs="24" :md="6" :xl="4" class="filter-block">
        <ProductFilter
          v-if="!type_pending && !brand_pending && !size_pending"
...
request_params.value.search = route.params.search;

// получить товары
const { data: products, refresh } = await useAsyncData("product_search", () =>
